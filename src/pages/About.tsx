      ...
      <div className="max-w-3xl">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-text-muted mt-1">Based in San Francisco, CA</p>
          </div>
        </div>
        ...
        {/* Key Technologies */}
        <section className="mt-10">
          <h2 className="text-lg font-semibold text-text-primary">Key Technologies</h2>
          <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="flex items-center gap-3 rounded-xl border border-portfolio-gray/20 bg-background px-5 py-4">
              <Atom className="h-5 w-5 text-portfolio-blue" />
              <span className="text-sm text-text-primary font-medium">React</span>
            </div>
            <div className="flex items-center gap-3 rounded-xl border border-portfolio-gray/20 bg-background px-5 py-4">
              <SquareFunction className="h-5 w-5 text-portfolio-green" />
              <span className="text-sm text-text-primary font-medium">Machine Learning</span>
            </div>
            <div className="flex items-center gap-3 rounded-xl border border-portfolio-gray/20 bg-background px-5 py-4">
              <Brain className="h-5 w-5 text-portfolio-red" />
              <span className="text-sm text-text-primary font-medium">Artificial Intelligence</span>
            </div>
          </div>
        </section>
      </div>
